                ...
                <div>
                    <div class="container ps-5">
                        <div class="row h-100 d-flex justify-content-center text-center">
                            <div class="col-md-4" v-for="(pesulap, index) in pesulaps" :key="index">
                                <div class="card" style="width: 20rem;">
                                    <img class="card-img-top" :src="url + bandsurl + pesulap.Image" alt="..."
                                        style="height: 200px;">
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                            <h2 class="fw-bolder">{{ pesulap.Nama }}</h2>
                                            <h5 class="">{{ pesulap.Deskripsi }}</h5>
                                            <p class="">Rp {{ formatPrice(pesulap.Harga) }}</p>
                                        </div>
                                    </div>
                                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                        <div class="text-center"><a class="btn btn-outline-success mt-auto">
                                                <router-link
                                                    :to="{ name: 'detailPesulap', params: { id: pesulap.id }, }"
